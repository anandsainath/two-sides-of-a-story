...
while i < 365:
    try:
        ...
        api_call = 'http://api.usatoday.com/open/articles?section=politics&keyword=US%20Presidential%20Elections&fromdate='+from_date_string+'&todate='+to_date_string+'&count=100&api_key=3h2rjm46uheekjrj5g8j4mqs&encoding=json'
